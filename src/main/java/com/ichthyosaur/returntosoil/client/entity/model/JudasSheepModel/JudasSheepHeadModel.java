...
public class JudasSheepHeadModel<T extends JudasSheepHeadEntity> extends EntityModel<T> {
    ...
    public JudasSheepHeadModel() {
        ...
        cube_r1.texOffs(32, 33).addBox(-4.5F, -3.5F, -4.5F, 9.0F, 8.0F, 8.0F, 0.0F, false);
        ...
        bottomjaw.texOffs(25, 24).addBox(-4.0F, 4.6F, -11.5F, 8.0F, 1.0F, 6.0F, 0.0F, false);
        bottomjaw.texOffs(0, 41).addBox(-2.0F, -2.5F, -10.5F, 4.0F, 6.0F, 7.0F, 0.0F, false);
        bottomjaw.texOffs(47, 19).addBox(-2.0F, 0.5F, -15.5F, 4.0F, 5.0F, 6.0F, 0.0F, false);
        bottomjaw.texOffs(0, 8).addBox(-4.0F, 1.5F, -13.0F, 8.0F, 3.0F, 13.0F, 0.0F, false);
        bottomjaw.texOffs(0, 24).addBox(-2.5F, 4.5F, -15.0F, 5.0F, 2.0F, 15.0F, 0.0F, false);

        cube_r2 = new ModelRenderer(this);
        cube_r2.setPos(0.0F, 1.5F, -12.0F);
        bottomjaw.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.6109F, 0.0F, 0.0F);
        cube_r2.texOffs(35, 49).addBox(-1.5F, -2.0F, -2.5F, 3.0F, 3.0F, 6.0F, 0.0F, false);
        ...
        cube_r3.setPos(0.0F, -10.0F, 6.0F);
        horns.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.2182F, 0.0F, 0.0F);
        cube_r3.texOffs(53, 49).addBox(-12.5F, 2.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
        cube_r3.texOffs(53, 49).addBox(8.5F, 2.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
        cube_r3.texOffs(0, 54).addBox(-12.5F, 4.0F, -6.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
        cube_r3.texOffs(0, 54).addBox(8.5F, 4.0F, -6.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
        cube_r3.texOffs(0, 0).addBox(-12.5F, -2.0F, -2.0F, 25.0F, 4.0F, 4.0F, 0.0F, false);

        cube_r4 = new ModelRenderer(this);
        cube_r4.setPos(10.5F, -4.0F, 0.5F);
        horns.addChild(cube_r4);
        setRotationAngle(cube_r4, -0.2182F, 0.0F, 0.0F);
        cube_r4.texOffs(15, 47).addBox(-22.5F, -2.0F, -3.5F, 3.0F, 4.0F, 7.0F, 0.0F, false);
        cube_r4.texOffs(15, 47).addBox(-1.5F, -2.0F, -3.5F, 3.0F, 4.0F, 7.0F, 0.0F, false); }
