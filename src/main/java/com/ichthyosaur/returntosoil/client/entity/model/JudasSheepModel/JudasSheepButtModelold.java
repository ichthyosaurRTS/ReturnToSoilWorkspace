...
public class JudasSheepButtModelold<T extends JudasSheepButtEntity> extends EntityModel<T > {
    ...
    @Override
    public void setupAnim(JudasSheepButtEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
